...
export class AddPage implements OnInit, AfterViewInit {
  ...
  @ViewChild("amazonmusic_segment", { static: false })
  amazonmusicSegment: IonSelect;
  @ViewChild("applemusic_segment", { static: false })
  applemusicSegment: IonSelect;
  ...
  @ViewChild("spotify_query", { static: true }) spotifyQuery: IonInput;
  @ViewChild("amazonmusic_artist", { static: false })
  amazonmusicArtist: IonInput;
  ...
  validate() {
    if (this.librarySegment) {
      this.librarySegment.disabled = false;
    }
    if (this.spotifySegment) {
      this.spotifySegment.disabled = false;
    }
    if (this.amazonmusicSegment) {
      this.amazonmusicSegment.disabled = false;
    }
    if (this.applemusicSegment) {
      this.applemusicSegment.disabled = false;
    }
    if (this.tuneinSegment) {
      this.tuneinSegment.disabled = false;
    }

    if (this.libraryArtist) {
      this.libraryArtist.disabled = false;
    }
    if (this.spotifyArtist) {
      this.spotifyArtist.disabled = false;
    }
    if (this.spotifyQuery) {
      this.spotifyQuery.disabled = false;
    }
    if (this.amazonmusicArtist) {
      this.amazonmusicArtist.disabled = false;
    }
    if (this.applemusicArtist) {
      this.applemusicArtist.disabled = false;
    }
    ...
    switch (this.category) {
      ...
      case "playlist":
        ...
        if (this.libraryArtist) {
          this.libraryArtist.disabled = true;
        }
        if (this.spotifyArtist) {
          this.spotifyArtist.disabled = true;
        }
        if (this.spotifyQuery) {
          this.spotifyQuery.disabled = true;
        }
        if (this.amazonmusicArtist) {
          this.amazonmusicArtist.disabled = true;
        }
        if (this.applemusicArtist) {
          this.applemusicArtist.disabled = true;
        }
        break;
      case "radio":
        if (this.librarySegment) {
          this.librarySegment.disabled = true;
        }
        if (this.spotifySegment) {
          this.spotifySegment.disabled = true;
        }
        if (this.amazonmusicSegment) {
          this.amazonmusicSegment.disabled = true;
        }
        if (this.applemusicSegment) {
          this.applemusicSegment.disabled = true;
        }
    }
    ...
    if (this.source === "spotify") {
      ...
      this.valid = title?.length > 0 && id?.length > 0;
    }
  }
}
